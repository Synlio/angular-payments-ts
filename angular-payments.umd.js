(function (global, factory) {
	...
	(factory((global['angular-payments'] = {}),global.core,global.forms,global.common));
...
var AngularPaymentsCardDirective = (function (_super) {
    ...
    AngularPaymentsCardDirective = AngularPaymentsCardDirective_1 = __decorate([
        core.Directive({
            selector: selector,
            providers: [
                { provide: forms.NG_VALIDATORS, useExisting: core.forwardRef(function () { return AngularPaymentsCardDirective_1; }), multi: true }
            ]
        }),
...
var AngularPaymentsCVCDirective = (function (_super) {
    ...
    AngularPaymentsCVCDirective = AngularPaymentsCVCDirective_1 = __decorate([
        core.Directive({
            selector: selector$1,
            providers: [
                { provide: forms.NG_VALIDATORS, useExisting: core.forwardRef(function () { return AngularPaymentsCVCDirective_1; }), multi: true }
            ]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof core.ElementRef !== "undefined" && core.ElementRef) === "function" && _a || Object])
...
var AngularPaymentsExpiryDirective = (function (_super) {
    ...
    AngularPaymentsExpiryDirective = AngularPaymentsExpiryDirective_1 = __decorate([
        core.Directive({
            selector: selector$2,
            providers: [
                { provide: forms.NG_VALIDATORS, useExisting: core.forwardRef(function () { return AngularPaymentsExpiryDirective_1; }), multi: true }
            ]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof core.ElementRef !== "undefined" && core.ElementRef) === "function" && _a || Object])
...
var AbstractCreditCardFormComponent = (function () {
    function AbstractCreditCardFormComponent(formBuilder) {
        ...
        this.number = new core.EventEmitter();
        this.cvc = new core.EventEmitter();
        this.expiry = new core.EventEmitter();
    ...
    AbstractCreditCardFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof forms.FormBuilder !== "undefined" && forms.FormBuilder) === "function" && _a || Object])
...
exports.AngularPaymentsModule = AngularPaymentsModule;
exports.AngularPaymentsCardDirective = AngularPaymentsCardDirective;
exports.AngularPaymentsCVCDirective = AngularPaymentsCVCDirective;
exports.AngularPaymentsExpiryDirective = AngularPaymentsExpiryDirective;
exports.AbstractCreditCardFormComponent = AbstractCreditCardFormComponent;
exports.CreditCardFormComponent = CreditCardFormComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=angular-payments.umd.js.map
